...
├── priors/           # Pre-trained generative priors (git-lfs)
...
| 46k 4-Epoch × 4-Block Reg | 46k in 4 blocks | 16 total block-epochs, regularized |
...
The `data/` directory contains triterpenoid saponin SMILES compiled from published literature (Zang E 2021, *Front. Pharmacol.*, and related sources). Datasets range from 3k to 46k SMILES.
...
- Zang E et al. (2021) *Front. Pharmacol.* — Compendium of 278 X. sorbifolium compounds
- NPClassifier: [npclassifier.gnps2.org](https://npclassifier.gnps2.org/)
- FCD (Fréchet ChemNet Distance): [pmed/fcd](https://github.com/pmed/fcd)